...
export function FlashCard({ card, flipped, onFlip }: FlashCardProps) {
  ...
  return (
    ...
    >
      <section className="absolute inset-0 p-5 md:p-6 backface-hidden flex flex-col gap-3 justify-center items-start">
      ...
      <section className="absolute inset-0 p-5 md:p-6 [transform:rotateY(180deg)] backface-hidden flex flex-col gap-4 justify-start">
        <h2 className="text-4xl md:text-5xl font-bold m-0">{card.front}</h2>
