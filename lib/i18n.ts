...
export const UI_TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    'share.description': 'Share this flashcard with others:',
    'share.close': 'Close',
    'share.copy': 'Copy',
    'share.copied': 'Copied!',
    'share.qr.alt': 'QR code to share this card',
    'share.qr.scan': 'Scan with your phone camera',
    'share.qr.error': 'QR code unavailable',
    'share.footer': 'Anyone with this link can view this card',
    'share.button': 'Share',
  },
  es: {
    ...
    'share.title': 'Compartir Esta Tarjeta',
    'share.description': 'Comparte esta tarjeta con otros:',
    'share.close': 'Cerrar',
    'share.copy': 'Copiar',
    'share.copied': '¡Copiado!',
    'share.qr.alt': 'Código QR para compartir esta tarjeta',
    'share.qr.scan': 'Escanea con la cámara de tu teléfono',
    'share.qr.error': 'Código QR no disponible',
    'share.footer': 'Cualquiera con este enlace puede ver esta tarjeta',
  ...
  fr: {
    ...
    'share.title': 'Partager Cette Carte',
    'share.description': 'Partagez cette carte avec d\'autres:',
    'share.close': 'Fermer',
    'share.copy': 'Copier',
    'share.copied': 'Copié!',
    'share.qr.alt': 'Code QR pour partager cette carte',
    'share.qr.scan': 'Scannez avec l\'appareil photo de votre téléphone',
    'share.qr.error': 'Code QR indisponible',
    'share.footer': 'Toute personne avec ce lien peut voir cette carte',
  ...
  de: {
    ...
    'share.title': 'Diese Karte Teilen',
    'share.description': 'Teilen Sie diese Karte mit anderen:',
    'share.close': 'Schließen',
    'share.copy': 'Kopieren',
    'share.copied': 'Kopiert!',
    'share.qr.alt': 'QR-Code zum Teilen dieser Karte',
    'share.qr.scan': 'Mit der Kamera Ihres Telefons scannen',
    'share.qr.error': 'QR-Code nicht verfügbar',
    'share.footer': 'Jeder mit diesem Link kann diese Karte ansehen',
    'share.button': 'Teilen',
  },
};
